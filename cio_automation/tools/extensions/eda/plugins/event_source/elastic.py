...
author: "Joao Lobo (joao.lobo@gmail.com)"
options:
    elastic_host:
        description:
            - URL of Elastic host
...
async def main(queue: asyncio.Queue, args: Dict[str, Any]):
    ...
    elastic_password = args.get("elastic_password", "Jlgn@1985")
    ...
    async with AsyncElasticsearch(f"{elastic_host}", basic_auth=(elastic_username, elastic_password)) as es:
